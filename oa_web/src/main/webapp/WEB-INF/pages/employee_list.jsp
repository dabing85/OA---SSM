                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <c:forEach items="${list}" var="em">
                            <tr class="message-unread">
                                ...
                                <td>${em.sn}</td>
                                <td>${em.name}</td>
                                <td class="text-center fw600">${em.departmentSn}</td>
                                <td class="hidden-xs">
                                    <span class="badge badge-warning mr10 fs11"> ${em.post}</span>
                                </td>
                                <td>
                                    <a href="/employee/to_update?sn=${em.sn}">编辑</a>
                                    <a href="/employee/remove?sn=${em.sn}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
