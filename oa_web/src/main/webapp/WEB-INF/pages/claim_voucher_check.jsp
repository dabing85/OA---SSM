...
<%@ page import="com.dabing.oa.global.Constant" %>
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.employee.post==Constant.POST_FM||sessionScope.employee.post==Constant.POST_GM}">
                                    <form:button type="submit" class="button" name="dealWay" value="${Constant.DEAL_PASS}" >${Constant.DEAL_PASS}</form:button>
                                    <form:button type="submit" class="button" name="dealWay" value="${Constant.DEAL_BACK}" >${Constant.DEAL_BACK}</form:button>
                                    <form:button type="submit" class="button" name="dealWay" value="${Constant.DEAL_REJECT}" >${Constant.DEAL_REJECT}</form:button>
                                </c:if>
